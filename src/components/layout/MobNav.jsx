{
  /* <nav class="bottom-nav" id="bottom-nav" aria-label="التنقل الرئيسي">
  <a href="#home" data-page="home" class="bottom-nav__item">
    <svg
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
  ...
  <a href="#works" data-page="works" class="bottom-nav__item">
    <svg
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
  ...
  <a href="#news" data-page="news" class="bottom-nav__item">
    <svg
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
  ...
  <a href="#faq" data-page="faq" class="bottom-nav__item">
    <svg
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
  ...
  <a href="#booking" data-page="booking" class="bottom-nav__item">
    <svg
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
